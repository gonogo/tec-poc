...
/**
 * Allows CCD to return and submit its hidden organisation-policy enrichment during case creation.
 */
public class OwnershipPolicyAccess implements HasAccessControl {
