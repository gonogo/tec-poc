// Override gem CollapsibleNavigation so clean URLs (/path/) match
// relative sidebar links (.../path/index.html). Loaded after govuk_tech_docs;
// document.ready has not run yet, so modules.start() picks this up.
(function ($, Modules) {
  'use strict'
